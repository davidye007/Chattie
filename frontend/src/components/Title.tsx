...
function Title({ setMessages }: Props) {
    ...
    return (
        <div className="flex justify-between items-center w-full p-4 bg-gray-500 text-white font-bold shadow">
            <div className="text-center text-2xl">Chat With Me</div>
            <button onClick={resetConversation} className={"transition-all duration-300 text-white hover:text-pink-400 " + (isResetting && "animate-pulse")}>
